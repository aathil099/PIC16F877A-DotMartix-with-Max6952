...
void init_max6952() {
    ...
    send_command(0x01, 0x0F);
    send_command(0x02, 0xF0);
}

void test_max6952() {
    send_command(0x07, 0x01);
...
void main(void) {
    ...
    uint8_t display_data2[] = {0x42, 0x33, 0x32, 0x31};
        ...
        _delay((unsigned long)((10000000)*(20000000/4000000.0)));
